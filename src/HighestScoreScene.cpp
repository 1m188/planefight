...
void HighestScoreScene::init()
{
    ...
    highestScoreLabel->setFont(QFont(u8"微软雅黑", 30));
    highestScoreLabel->setText(QString::number(Config::getInstance()->highestScore()) + "          " + Config::getInstance()->highestScorePlayer());
